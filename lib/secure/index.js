...
var secure = {
	...
	login : function(username, password){
		...
		this.findUser(username).done(function(user){
			d._resolve(self.createSession(user, password));
	...
	findUser : function(username){
		...
		User.findOne({username : username}, function(err, user){
			...
			user ? d.resolve(user) : d.reject(new Error('user not exixts'));
